...
export default function Main() {
  const { checkNetwork, networkError, todos, isLoading, toggleTodo, deleteTodo, updateTodo, addTodo } = useTodos();
  ...
  return (
        <main className="main">
            ...
            <NetworkNotification networkError={networkError} checkNetwork={checkNetwork} />
        </main>
    )
}
